...
/*
 * ARM Cortex M4 Register NVIC ISERx register Addresses
 */
...
/*
 * ARM Cortex M4 Register NVIC ICERx register Addresses
 */
...
#define SRAM1_BASEADDR				0x20000000U						/*this is the base address of sram1*/
#define SRAM2_BASEADDR				0x2001C000U						/*this is the base address of sram2*/
//#define SRAM3_BASEADDR				0x20020000U					//FAST RAM ONLY FOR CPU ,peripherals and DMA cannot use it
#define ROM_BASEADDR		        0x1FFF0000U						/*this is the base address of ROM, which is also known as system memory */
...
#define PERIPH_BASEADDR				0x40000000U						/*this is the base address of peripheral buses*/
#define APB1PERIPH_BASEADDR			PERIPH_BASEADDR					/*this is the base address of APB1 peripheral bus*/
#define APB2PERIPH_BASEADDR			0x40010000U						/*this is the base address of APB2 peripheral bus*/
#define AHB1PERIPH_BASEADDR			0x40020000U						/*this is the base address of AHB1 peripheral bus*/
#define AHB2PERIPH_BASEADDR			0x50000000U						/*this is the base address of AHB2 peripheral bus*/
 ...
 * Compared to number of registers of SPI peripheral of STM32Lx or STM32F0x family of MCU's
...
typedef struct
{
	...
	__vo uint32_t AFR[2];		/*to access AFRH and AFRL we can do AFR[0] means AFRL register and AFR[1] means AFRH register or we can create separate (uint32_t AFRL) and (uint32_t AFRH)*/

}GPIO_RegDef_t;


/*Typedef structure for RCC registers*/
...
typedef struct
{
	...
	uint32_t Reserved2;			/*Reserved 2													Address offset: 0x28*/
...
/*
 *
 * Clock Enable Macros for SYGFGx Peripherals
 *
 */
...
/*
 *
 * Clock Disable Macros for SYGFGx Peripherals
 *
 */
 ...
 */
#define GPIOA_REG_RESET()			do {(RCC -> AHB1RSTR |= (1 << 0)); (RCC -> AHB1RSTR &= ~(1 << 0));}while(0)		/*This is a technique in C programming to execute multiple 'C' statements using single C macro*/
...
#define GPIO_BASEADDR_TO_CODE(x)  ((x == GPIOA) ? 0 : \
                                  ...
                                  (x == GPIOF) ? 5 : \
                                  (x == GPIOG) ? 6 : \
                                  (x == GPIOH) ? 7 : 0)		/*Ternary operator for multiple choices between the ports*/

/*
 * Bit Positions definitions for SPI_CR1
 */
